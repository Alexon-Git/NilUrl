                ...
                <div className="d3_2">
                    <form className="f3_1">
                        <input type="text" data-t="field:input-login" dir="ltr" aria-invalid="false" autoCorrect="off" autoCapitalize="off" autoComplete="username"
                               className="in3_1" id="passp-field-login" name="login" placeholder="email" value=""/>
                    </form>
                    <form className="f3_2">
                        <input type="text" data-t="field:input-login" dir="ltr" aria-invalid="false" autoCorrect="off" autoCapitalize="off" autoComplete="username"
                               className="in3_1" id="passp-field-login" name="login" placeholder="password" value=""/>
                    </form>
                    ...
                    <p className="p3_1">Не имеете аккаунта?
                        <a className="a3_2" href="/register" onClick={()=>{navigate(REGPAGE_ROUTE)}}>Регестрация</a>
                        .</p>
                </div>
            </div>
        </div>
