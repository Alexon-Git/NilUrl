...
const VerifyCodeModalPassword = ({ onClose, onSuccess, password }) => {
  ...
  const handleVerification = () => {
    fetch("https://nilurl.ru:8000/verify_password_update_code.php", {
      method: "POST",
      headers: {
...
export default VerifyCodeModalPassword;